...
const PricingPlans = () => {
  return (
    <div className='mx-7 my-10 flex  justify-center'>
      <div className='w-full md:w-[900px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 lg:gap-4 justify-items-center'>
        {
